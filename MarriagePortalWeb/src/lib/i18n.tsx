...
const en: Dict = {
  ...
  lg_account: "Member account (login)",
  acc_hint: "Choose a username and password to sign in to the portal. A parish admin will activate your account after review.",
...
const ta: Dict = {
  ...
  lg_account: "உறுப்பினர் கணக்கு (உள்நுழைவு)",
  acc_hint: "தளத்தில் உள்நுழைய பயனர்பெயர் மற்றும் கடவுச்சொல்லைத் தேர்ந்தெடுக்கவும். நிர்வாகி சரிபார்த்த பிறகு கணக்கு செயல்படுத்தப்படும்.",
