...
export default async function ProfilePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <ProfileDetailView p={{ ...p, mainPhotoUrl: null, mobile: null, presbyterName: null, presbyterContact: null, refereeName: null, refereeContact: null }} hasPhoto={hasPhoto} />;
}
