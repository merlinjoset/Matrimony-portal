...
export async function GET(_req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  return Response.json(isAdmin ? profile : { ...profile, membershipNo: null, mobile: null, presbyterName: null, presbyterContact: null, refereeName: null, refereeContact: null });
}
